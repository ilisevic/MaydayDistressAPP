...
import static io.github.ilisevic.SOSbasic.utils.App.CHANNEL_2_ID;

//import static io.github.ilisevic.SOSbasic.AppFlash.CHANNEL_FLASH_ID;
...
////
        ...
        Toast.makeText(getBaseContext(), getString(R.string.DeviceGotAFlash) + isFlashAvailable, Toast.LENGTH_SHORT).show();
